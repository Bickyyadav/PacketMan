...
const SearchBar = () => {
    ...
    return (
        <>
            <button className='relative flex flex-1 self-stretch cursor-text  items-center justify-between  rounded bg-zinc-900 px-4 py-2 text-gray-500 transition hover:bg-zinc-800 hover:text-gray-200 focus-visible:bg-zinc-700 focus-visible:text-gray-200 overflow-hidden'>
